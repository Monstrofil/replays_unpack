...
# property size: 32
    @property
    def markerHeightFactor(self):
        return self._markerHeightFactor

    @markerHeightFactor.setter
    def markerHeightFactor(self, value):
        self._markerHeightFactor, = unpack_variables(value, ['FLOAT'])
