...
class Account(AccountCMDs, AccountEditor, BattleStarter, WalletOwner, AccountPData, EntityLookuper, VoiceChatClient, StatsPublisher, TransactionAPI):
    ...
    g_curVersion_release_8_0_0_1298893 = EventHook()
    ...
    def __init__(self):
        ...
        for item in [
            ...
            (65, 'onCheckGamePing'),
            (9, 'setTrace'),
            (1, 'curVersion_release_8_0_0_1298893'),
...
# method size: 1
    @unpack_func_args([])
    def curVersion_release_8_0_0_1298893(self):
        self.g_curVersion_release_8_0_0_1298893.fire(self)
# method size: 10000000001
    @unpack_func_args(['STRING'])
...
# method size: 105
    @unpack_func_args(['INT8', 'UINT32', ['ARRAY', 'UINT32', 2]])
    def onGetArcEventProgress(self, arg1, arg2, arg3):
        self.g_onGetArcEventProgress.fire(self, arg1, arg2, arg3)
# method size: 65
...
# method size: 9
    @unpack_func_args(['BOOL'])
    def receiveEmailBind(self, arg1):
        self.g_receiveEmailBind.fire(self, arg1)
