...
class Weather(object):
    ...
    @property
    def logicParams(self):
        return self._logicParams

    @logicParams.setter
    def logicParams(self, value):
        self._logicParams, = unpack_variables(value, ['WEATHER_LOGIC_PARAMS'])
