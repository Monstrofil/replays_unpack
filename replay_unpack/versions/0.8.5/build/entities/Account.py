...
class Account(AccountCMDs, AccountEditor, BattleStarterClient, WalletOwner, AccountPData, EntityHelperAPI, VoiceChatClient, StatsPublisher, TransactionAPI, AccountUsersRequester):
    ...
    g_curVersion_release_8_5_0_1619877 = EventHook()
    ...
    def __init__(self):
        ...
        for item in [
            ...
            (65, 'onCheckGamePing'),
            (9, 'setTrace'),
            (1, 'curVersion_release_8_5_0_1619877'),
...
# method size: 1
    @unpack_func_args([])
    def curVersion_release_8_5_0_1619877(self):
        self.g_curVersion_release_8_5_0_1619877.fire(self)
# method size: 10000000001
    @unpack_func_args(['STRING'])
