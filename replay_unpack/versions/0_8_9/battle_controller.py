...
class BattleController(IBattleController):
    ...
    def __init__(self):
        ...
        Entity.subscribe_method_call('Avatar', Entity.Type.CLIENT, 'onBattleEnd', self.onBattleEnd)
        ...
        Entity.subscribe_method_call('Avatar', Entity.Type.CLIENT, 'receive_planeDeath', self.receive_planeDeath)
    ...
    def onArenaStateReceived(self, avatar, arenaUniqueId, teamBuildTypeId, preBattlesInfo, playersStates, spectatorsStates, buildingsInfo):
        self._players.create_or_update_players(
