...
property_id_map = {'crewParams': 5, 'isLeaver': 16, 'isConnected': 14, 'clanID': 3, 'dogTag': 6, 'isBot': 12, 'shipId': 27, 'avatarId': 1, 'id': 8, 'ttkStatus': 31, 'realm': 25, 'clanColor': 2, 'killedBuildingsCount': 18, 'maxHealth': 19, 'preBattleSign': 22, 'isAbuser': 10, 'clanTag': 4, 'isHidden': 15, 'isAlive': 11, 'preBattleIdOnStart': 21, 'prebattleId': 23, 'accountDBID': 0, 'isPreBattleOwner': 17, 'shipParamsId': 28, 'shipComponents': 26, 'name': 20, 'teamId': 30, 'invitationsEnabled': 9, 'fragsCount': 7, 'skinId': 29, 'isClientLoaded': 13, 'rankInfoDump': 24}
