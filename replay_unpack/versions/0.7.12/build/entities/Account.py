...
class Account(AccountCMDs, AccountEditor, BattleStarter, WalletOwner, AccountPData, EntityLookuper, VoiceChatClient, StatsPublisher, TransactionAPI):
    ...
    g_curVersion_release_7_12_0_1219756 = EventHook()
    ...
    def __init__(self):
        ...
        self._methods.extend([
            ...
            (65, 'onCheckGamePing'),
            (9, 'setTrace'),
            (1, 'curVersion_release_7_12_0_1219756'),
...
# method size: 1
    @unpack_func_args([])
    def curVersion_release_7_12_0_1219756(self):
        self.g_curVersion_release_7_12_0_1219756.fire(self)
# method size: 10000000001
    @unpack_func_args(['STRING'])
