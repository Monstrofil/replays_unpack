...
class AtbaOwner(object):
    ...
    @property
    def timeLastShootATBA(self):
        return self._timeLastShootATBA

    @timeLastShootATBA.setter
    def timeLastShootATBA(self, value):
        self._timeLastShootATBA, = unpack_variables(value, ['FLOAT32'])
