...
# property size: 10000000000
    ...
    def teams(self, value):
        self._teams, = unpack_variables(value, ['TEAMS_DEF'])
# property size: 10000000000
    @property
    def debugText(self):
...
# property size: 10000000000
    @property
    def mapBorder(self):
        return self._mapBorder

    @mapBorder.setter
    def mapBorder(self, value):
        self._mapBorder, = unpack_variables(value, ['MAP_BORDER'])
