...
class HitLocationManagerOwner(object):
    ...
    @property
    def battleLogicId(self):
        return self._battleLogicId

    @battleLogicId.setter
    def battleLogicId(self, value):
        self._battleLogicId, = unpack_variables(value, ['ENTITY_ID'])
