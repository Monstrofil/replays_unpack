...
class Account(AccountCMDs, AccountEditor, BattleStarterClient, WalletOwner, AccountPData, EntityHelperAPI, VoiceChatClient, StatsPublisher, GiveClientHelper, AccountUsersRequester):
    ...
    g_curVersion_release_8_7_0_1780849 = EventHook()
    ...
    def __init__(self):
        ...
        for item in [
            ...
            (65, 'onCheckGamePing'),
            (9, 'setTrace'),
            (1, 'curVersion_release_8_7_0_1780849'),
...
# method size: 1
    @unpack_func_args([])
    def curVersion_release_8_7_0_1780849(self):
        self.g_curVersion_release_8_7_0_1780849.fire(self)
# method size: 10000000001
    @unpack_func_args(['STRING'])
