...
class AirDefenceOwner(object):
    ...
    def __init__(self):
        ...
        self._hasAirTargetsInRange = 0.0
...
# property size: 8
    @property
    def hasAirTargetsInRange(self):
        return self._hasAirTargetsInRange

    @hasAirTargetsInRange.setter
    def hasAirTargetsInRange(self, value):
        self._hasAirTargetsInRange, = unpack_variables(value, ['BOOL'])
