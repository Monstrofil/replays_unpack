...
from interfaces.AccountUsersRequester import AccountUsersRequester



class Account(AccountCMDs, AccountEditor, BattleStarterClient, WalletOwner, AccountPData, EntityHelperAPI, VoiceChatClient, StatsPublisher, GiveClientHelper, AccountUsersRequester):
    ...
    g_curVersion_release_8_11_0_2118554 = EventHook()
    ...
    g_onShipBranchDropped = EventHook()
    ...
    g_onUpdateParentControlRestrictionStatus = EventHook()
    ...
    g_receiveReferralPoints = EventHook()
    
    g_onNotReferralMember = EventHook()
    
    g_sendClientLogsToStorage = EventHook()
    
    g_receiveShipyardUserData = EventHook()
    ...
    def __init__(self):
        ...
        AccountUsersRequester.__init__(self)
        ...
        for item in [
            ...
            (65, 'onCheckGamePing'),
            (9, 'setTrace'),
            (1, 'curVersion_release_8_11_0_2118554'),
            ...
            (10000000001, 'onGetClanBattlesStage'),
            ...
            (97, 'onUpdateParentControlRestrictionStatus'),
            (9, 'receiveIngameNews'),
            ...
            (65, 'receiveReferralPoints'),
            (1, 'onNotReferralMember'),
            (10000000001, 'sendClientLogsToStorage'),
            (10000000001, 'receiveShipyardUserData'),
...
# method size: 1
    @unpack_func_args([])
    def curVersion_release_8_11_0_2118554(self):
        self.g_curVersion_release_8_11_0_2118554.fire(self)
# method size: 10000000001
    @unpack_func_args(['STRING'])
...
# method size: 9
    @unpack_func_args(['UINT8'])
    def onStartSyncSSE(self, arg1):
        self.g_onStartSyncSSE.fire(self, arg1)
# method size: 33
    @unpack_func_args(['UINT32'])
...
# method size: 41
    @unpack_func_args(['SHIP_ID', 'BOOL'])
    def onShipBranchDropped(self, arg1, arg2):
        self.g_onShipBranchDropped.fire(self, arg1, arg2)
# method size: 10000000001
...
# method size: 10000000001
    @unpack_func_args(['RANK_BATTLES_PLAYER_INFO', 'UINT32', ['ARRAY', 'INT8']])
    def onGetRankBattlesPlayerInfo(self, arg1, arg2, arg3):
        self.g_onGetRankBattlesPlayerInfo.fire(self, arg1, arg2, arg3)
# method size: 41
...
# method size: 10000000001
    @unpack_func_args(['UINT32', 'STRING', 'UINT8'])
    def onGetClanBattlesStage(self, arg1, arg2, arg3):
        self.g_onGetClanBattlesStage.fire(self, arg1, arg2, arg3)
# method size: 10000000001
    @unpack_func_args(['BLOB'])
...
# method size: 97
    @unpack_func_args(['UINT32', 'UINT32', 'UINT32'])
    def onUpdateParentControlRestrictionStatus(self, arg1, arg2, arg3):
        self.g_onUpdateParentControlRestrictionStatus.fire(self, arg1, arg2, arg3)
# method size: 9
    @unpack_func_args(['UINT8'])
...
# method size: 65
    @unpack_func_args(['UINT64'])
    def receiveReferralPoints(self, arg1):
        self.g_receiveReferralPoints.fire(self, arg1)
# method size: 1
    @unpack_func_args([])
    def onNotReferralMember(self):
        self.g_onNotReferralMember.fire(self)
# method size: 10000000001
    @unpack_func_args(['UNICODE_STRING'])
    def sendClientLogsToStorage(self, arg1):
        self.g_sendClientLogsToStorage.fire(self, arg1)
# method size: 10000000001
    @unpack_func_args(['MSGPACK_BLOB'])
    def receiveShipyardUserData(self, arg1):
        self.g_receiveShipyardUserData.fire(self, arg1)
