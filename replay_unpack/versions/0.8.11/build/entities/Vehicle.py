...
class Vehicle(VisionOwner, AtbaOwner, AirDefenceOwner, DebugDrawEntity, HitLocationManagerOwner, AviationOwner, BuoyancyOwner, WeatherOwner, ModelOwner):
    ...
    g_setAdditionalGMMaxDistCoeff = EventHook()
    ...
    def __init__(self):
        ...
        for item in [
            ...
            (33, 'setAdditionalGMMaxDistCoeff'),
            (1, 'onReseted'),
...
# method size: 33
    @unpack_func_args(['FLOAT'])
    def setAdditionalGMMaxDistCoeff(self, arg1):
        self.g_setAdditionalGMMaxDistCoeff.fire(self, arg1)
# method size: 1
    @unpack_func_args([])
    def onReseted(self):
