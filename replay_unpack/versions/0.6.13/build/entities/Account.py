...
class Account(AccountEditor, BattleStarter, WalletOwner, AccountPData, EntityLookuper, VoiceChatClient, StatsPublisher):
    ...
    g_curVersion_Release_0_6_13_0_296659 = EventHook()
    ...
    @unpack_func_args([])
    def curVersion_Release_0_6_13_0_296659(self):
        self.g_curVersion_Release_0_6_13_0_296659.fire(self)
    ...
    @unpack_func_args(['STRING', 'STRING', 'UINT32'])
