...
class Account(AccountCMDs, AccountEditor, BattleStarter, WalletOwner, AccountPData, EntityLookuper, VoiceChatClient, StatsPublisher, TransactionAPI):
    ...
    g_curVersion_release_7_7_0_939750 = EventHook()
    ...
    def __init__(self):
        ...
        self._methods.extend([
            ...
            (65, 'onCheckGamePing'),
            (9, 'setTrace'),
            (1, 'curVersion_release_7_7_0_939750'),
...
# method size: 1
    @unpack_func_args([])
    def curVersion_release_7_7_0_939750(self):
        self.g_curVersion_release_7_7_0_939750.fire(self)
# method size: 10000000001
