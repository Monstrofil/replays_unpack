...
class Account(AccountCMDs, AccountEditor, BattleStarter, WalletOwner, AccountPData, EntityLookuper, VoiceChatClient, StatsPublisher, TransactionAPI):
    ...
    g_curVersion_release_7_10_0_1099163 = EventHook()
    ...
    def __init__(self):
        ...
        self._methods.extend([
            ...
            (65, 'onCheckGamePing'),
            (9, 'setTrace'),
            (1, 'curVersion_release_7_10_0_1099163'),
...
# method size: 1
    @unpack_func_args([])
    def curVersion_release_7_10_0_1099163(self):
        self.g_curVersion_release_7_10_0_1099163.fire(self)
# method size: 10000000001
    @unpack_func_args(['STRING'])
