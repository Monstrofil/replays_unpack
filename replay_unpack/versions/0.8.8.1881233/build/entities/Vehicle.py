...
class Vehicle(VisionOwner, AtbaOwner, AirDefenceOwner, DebugDrawEntity, HitLocationManagerOwner, AviationOwner, BuoyancyOwner, WeatherOwner, ModelOwner):
    ...
    g_setCooldownTorpedoes = EventHook()
    ...
    def __init__(self):
        ...
        for item in [
            ...
            (10000000002, 'setCooldownTorpedoes'),
...
# method size: 9
    @unpack_func_args(['UINT8'])
    def setAmmoTorpedoTubes(self, arg1):
        self.g_setAmmoTorpedoTubes.fire(self, arg1)
...
# method size: 145
    @unpack_func_args(['INT32', 'VECTOR3', 'UINT16'])
    def shootDepthCharge(self, arg1, arg2, arg3):
        self.g_shootDepthCharge.fire(self, arg1, arg2, arg3)
# method size: 17
...
# method size: 10000000002
    @unpack_func_args(['BLOB'])
    def setCooldownTorpedoes(self, arg1):
        self.g_setCooldownTorpedoes.fire(self, arg1)
# method size: 10000000001
    @unpack_func_args(['BLOB'])
