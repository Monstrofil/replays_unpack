...
from interfaces.GiveClientHelper import GiveClientHelper



class Avatar(VoiceChatClient, StatsPublisher, GiveClientHelper):
    
    g_onGetSubmarine = EventHook()
    
    g_torpedoParamsUpdate = EventHook()
    
    g_waveSended = EventHook()
    
    g_waveEnded = EventHook()
    
    g_stopPingGame = EventHook()
    ...
    g_receiveTorpedoAccoustic = EventHook()
    
    g_receiveTorpedoAccousticTurnOff = EventHook()
    
    g_receiveTorpedoPositionDirection = EventHook()
    ...
    g_setSurfaceHydrophone = EventHook()
    
    g_setSubmarineHydrophone = EventHook()
    
    g_hideIntuitionIndicator = EventHook()
    
    g_hideHydrophoneIndicator = EventHook()
    ...
    def __init__(self):
        ...
        self._respawnTime = None

        self._isAlive = 1.0

        self._willBeDeadAtTime = 0.0

        self._isSpectator = 0.0

        self._wavedVehicles = None

        self._observedTeamId = 100.0
        ...
        GiveClientHelper.__init__(self)
        ...
        for item in [
            ...
            (337, 'receiveTorpedoAccoustic'),
            (49, 'receiveTorpedoAccousticTurnOff'),
            (241, 'receiveTorpedoPositionDirection'),
            ...
            (9, 'setIntuitionAngle'),
            (9, 'setSurfaceHydrophone'),
            (41, 'setSubmarineHydrophone'),
            (1, 'hideIntuitionIndicator'),
            (1, 'hideHydrophoneIndicator'),
            (33, 'ownSmokeCreated'),
...
# method size: 129
    @unpack_func_args(['ENTITY_ID', 'INT32', 'INT32', 'FLOAT'])
    def onGetSubmarine(self, arg1, arg2, arg3, arg4):
        self.g_onGetSubmarine.fire(self, arg1, arg2, arg3, arg4)
# method size: 65
    @unpack_func_args(['PLAYER_ID', 'UINT16', 'UINT16'])
    def torpedoParamsUpdate(self, arg1, arg2, arg3):
        self.g_torpedoParamsUpdate.fire(self, arg1, arg2, arg3)
# method size: 65
    @unpack_func_args(['UINT32', 'FLOAT'])
    def waveSended(self, arg1, arg2):
        self.g_waveSended.fire(self, arg1, arg2)
# method size: 33
    @unpack_func_args(['UINT32'])
    def waveEnded(self, arg1):
        self.g_waveEnded.fire(self, arg1)
# method size: 1
    @unpack_func_args([])
    def stopPingGame(self):
        self.g_stopPingGame.fire(self)
# method size: 17
...
# method size: 10000000002
    ...
    def onGameRoomStateChanged(self, arg1, arg2):
        self.g_onGameRoomStateChanged.fire(self, arg1, arg2)
# method size: 10000000001
...
# method size: 337
    @unpack_func_args(['PLAYER_ID', 'UINT16', 'VECTOR3', 'VECTOR3', 'FLOAT', 'FLOAT', 'FLOAT'])
    def receiveTorpedoAccoustic(self, arg1, arg2, arg3, arg4, arg5, arg6, arg7):
        self.g_receiveTorpedoAccoustic.fire(self, arg1, arg2, arg3, arg4, arg5, arg6, arg7)
# method size: 49
    @unpack_func_args(['PLAYER_ID', 'UINT16'])
    def receiveTorpedoAccousticTurnOff(self, arg1, arg2):
        self.g_receiveTorpedoAccousticTurnOff.fire(self, arg1, arg2)
# method size: 241
    @unpack_func_args(['PLAYER_ID', 'UINT16', 'VECTOR3', 'VECTOR3'])
    def receiveTorpedoPositionDirection(self, arg1, arg2, arg3, arg4):
        self.g_receiveTorpedoPositionDirection.fire(self, arg1, arg2, arg3, arg4)
# method size: 10000000001
...
# method size: 33
    @unpack_func_args(['UINT32'])
    def receiveShootDC(self, arg1):
        self.g_receiveShootDC.fire(self, arg1)
# method size: 10000000001
...
# method size: 10000000001
    @unpack_func_args(['INT64', 'INT8', 'BLOB', 'BLOB', 'BLOB', 'BLOB'])
    def onArenaStateReceived(self, arg1, arg2, arg3, arg4, arg5, arg6):
        self.g_onArenaStateReceived.fire(self, arg1, arg2, arg3, arg4, arg5, arg6)
# method size: 10000000001
    @unpack_func_args(['BLOB'])
...
# method size: 9
    ...
    def setSurfaceHydrophone(self, arg1):
        self.g_setSurfaceHydrophone.fire(self, arg1)
# method size: 41
    @unpack_func_args(['UINT16', 'UINT16', 'BOOL'])
    def setSubmarineHydrophone(self, arg1, arg2, arg3):
        self.g_setSubmarineHydrophone.fire(self, arg1, arg2, arg3)
# method size: 1
    @unpack_func_args([])
...
# method size: 1
    @unpack_func_args([])
    def hideHydrophoneIndicator(self):
        self.g_hideHydrophoneIndicator.fire(self)
# method size: 33
...
# property size: 16
    ...
    def respawnTime(self, value):
        self._respawnTime, = unpack_variables(value, ['UINT16'])
# property size: 8
    @property
    def isAlive(self):
...
# property size: 8
    ...
    def isSpectator(self):
        return self._isSpectator

    @isSpectator.setter
    def isSpectator(self, value):
        self._isSpectator, = unpack_variables(value, ['BOOL'])
# property size: 10000000000
    @property
    def wavedVehicles(self):
        return self._wavedVehicles

    @wavedVehicles.setter
    def wavedVehicles(self, value):
        self._wavedVehicles, = unpack_variables(value, [['ARRAY', 'VEHICLE_WAVES_INFO']])
# property size: 8
    @property
    def observedTeamId(self):
        return self._observedTeamId

    @observedTeamId.setter
    def observedTeamId(self, value):
        self._observedTeamId, = unpack_variables(value, ['TEAM_ID'])
