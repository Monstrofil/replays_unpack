...
from SubmarineSearchPoint import SubmarineSearchPoint
...
ENTITIES = [Avatar, Vehicle, Account, SmokeScreen, Fog, OfflineEntity, Login, Building, AccountController, MasterChanger, BattleLogic, ReplayLeech, ReplayConnectionHandler, SubmarineSearchPoint, ]