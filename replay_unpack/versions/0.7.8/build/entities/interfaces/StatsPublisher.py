...
class StatsPublisher(object):
    ...
    def __init__(self):
        ...
        self._methods.extend([
            (10000000001, 'receivePublicIntStat'),
            (10000000001, 'receivePublicFloatStat'),
            (1, 'commitStats'),
...
# method size: 10000000001
    @unpack_func_args(['STRING', 'INT32', 'BOOL'])
    def receivePublicIntStat(self, arg1, arg2, arg3):
        self.g_receivePublicIntStat.fire(self, arg1, arg2, arg3)
# method size: 10000000001
    @unpack_func_args(['STRING', 'FLOAT', 'BOOL'])
    def receivePublicFloatStat(self, arg1, arg2, arg3):
        self.g_receivePublicFloatStat.fire(self, arg1, arg2, arg3)
# method size: 1
    @unpack_func_args([])
    def commitStats(self):
        self.g_commitStats.fire(self)
