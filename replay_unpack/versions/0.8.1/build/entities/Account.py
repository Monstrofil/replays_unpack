...
class Account(AccountCMDs, AccountEditor, BattleStarter, WalletOwner, AccountPData, EntityLookuper, VoiceChatClient, StatsPublisher, TransactionAPI):
    ...
    g_curVersion_release_8_1_0_1359980 = EventHook()
    ...
    def __init__(self):
        ...
        for item in [
            ...
            (65, 'onCheckGamePing'),
            (9, 'setTrace'),
            (1, 'curVersion_release_8_1_0_1359980'),
...
# method size: 1
    @unpack_func_args([])
    def curVersion_release_8_1_0_1359980(self):
        self.g_curVersion_release_8_1_0_1359980.fire(self)
# method size: 10000000001
    @unpack_func_args(['STRING'])
