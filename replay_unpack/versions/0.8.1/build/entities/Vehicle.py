...
# property size: 8
    @property
    def prioritySector(self):
        return self._prioritySector

    @prioritySector.setter
    def prioritySector(self, value):
        self._prioritySector, = unpack_variables(value, ['INT8'])
# property size: 16
    @property
