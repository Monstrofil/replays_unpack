...
class Account(AccountEditor, BattleStarter, WalletOwner, AccountPData, EntityLookuper, VoteBase, VoiceChatClient):
    ...
    g_curVersion_Release_0_6_11_1_285845 = EventHook()
    ...
    @unpack_func_args([])
    def curVersion_Release_0_6_11_1_285845(self):
        self.g_curVersion_Release_0_6_11_1_285845.fire(self)
    ...
    @unpack_func_args(['STRING', 'UINT16', 'STRING', 'UINT32'])
