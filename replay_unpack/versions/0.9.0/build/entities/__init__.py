...
from InteractiveZone import InteractiveZone
...
ENTITIES = [Avatar, Vehicle, Account, SmokeScreen, Fog, OfflineEntity, Login, Building, AccountController, MasterChanger, BattleLogic, ReplayLeech, ReplayConnectionHandler, InteractiveZone, ]