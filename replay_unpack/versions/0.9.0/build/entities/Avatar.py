...
class Avatar(VoiceChatClient, StatsPublisher, GiveClientHelper):
    ...
    g_receiveModifierSourceType = EventHook()
    ...
    def __init__(self):
        ...
        self._consumableWorkTimeCoef = '1.0'
        ...
        self._planeEngineForsagCoef = '1.0'

        self._planeConsumableReloadTimeCoef = '1.0'

        self._planeReloadTimeCoef = '1.0'
        ...
        for item in [
            ...
            (32, 'consumableWorkTimeCoef'),
            (32, 'rudderTimeCoef'),
            (16, 'respawnTime'),
            (8, 'isAlive'),
            (16, 'willBeDeadAtTime'),
            (16, 'playerMode'),
            (32, 'planeEngineForsagCoef'),
            (32, 'planeConsumableReloadTimeCoef'),
            (32, 'planeReloadTimeCoef'),
...
# method size: 41
    @unpack_func_args(['GAMEPARAMS_ID', 'INT8'])
    def receiveModifierSourceType(self, arg1, arg2):
        self.g_receiveModifierSourceType.fire(self, arg1, arg2)
...
# property size: 32
    @property
    def consumableWorkTimeCoef(self):
        return self._consumableWorkTimeCoef

    @consumableWorkTimeCoef.setter
    def consumableWorkTimeCoef(self, value):
        self._consumableWorkTimeCoef, = unpack_variables(value, ['FLOAT'])
# property size: 32
    @property
...
# property size: 16
    ...
    @playerMode.setter
    def playerMode(self, value):
        self._playerMode, = unpack_variables(value, ['PLAYER_MODE'])
# property size: 32
    @property
    def planeEngineForsagCoef(self):
        return self._planeEngineForsagCoef

    @planeEngineForsagCoef.setter
    def planeEngineForsagCoef(self, value):
        self._planeEngineForsagCoef, = unpack_variables(value, ['FLOAT'])
# property size: 32
    @property
    def planeConsumableReloadTimeCoef(self):
        return self._planeConsumableReloadTimeCoef

    @planeConsumableReloadTimeCoef.setter
    def planeConsumableReloadTimeCoef(self, value):
        self._planeConsumableReloadTimeCoef, = unpack_variables(value, ['FLOAT'])
# property size: 32
    @property
    def planeReloadTimeCoef(self):
        return self._planeReloadTimeCoef

    @planeReloadTimeCoef.setter
    def planeReloadTimeCoef(self, value):
        self._planeReloadTimeCoef, = unpack_variables(value, ['FLOAT'])
