...
CLIENT_PUBLIC_RESULTS = (
    ...
    'enemy_energy_burned', 'teamLadder', 'key_target_markers', 'victory_points_cp_base_capture', 
    'victory_points_cp_neutral_capture', 'victory_points_cp_team_capture', 'victory_points_cp_hold', 
    'victory_points_cp_base_block', 'victory_points_cp_neutral_block', 'victory_points_cp_team_block', 
    'victory_points_cp_earning_block', 'victory_points_cp_base_drop', 'victory_points_cp_neutral_drop', 
    'victory_points_cp_team_drop', 'victory_points_arms_race_drop_pickup', 
    'victory_points_kill_destroyer', 'victory_points_kill_cruiser', 'victory_points_kill_battleship', 
    'victory_points_kill_carrier', 'victory_points_kill_submarine', 'victory_points_own_ship_kill', 
    'victory_points_victory_by_kill', 'victory_points_victory_by_score_zero', 
    'victory_points_victory_by_capture', 'victory_points_cp_battle_end_base', 
    'victory_points_cp_battle_end_neutral', 'victory_points_cp_battle_end_team', 
    'victory_points_pull_pulled_to_destination', 'victory_points_pull_win_extermination', 
    'victory_points_pull_kill', 'victory_points_pull_pulling', 'victory_points_pull_enemy_blocking', 
    'victory_points_pull_pulling_while_blocked', 'victory_points_protection_attackers_lose', 
    'victory_points_protection_target_killed', 'victory_points_protection_target_reached', 
    'victory_points_protection_enemy_skip_kill', 'victory_points_victory_general', 
    'planes_killed_scouts', 'planes_killed_sfighters', 'planes_killed_fighters', 
    'planes_killed_bombers', 'planes_killed_tbombers', 'planes_killed_skipbombers', 'he_hits_bomb', 
    'he_hits_bomb_avia', 'he_hits_bomb_airsupport', 'pierced_hits_main', 'team_damage', 'ships_lost', 
    'planes_lost', 'pt_reward_boost', 'pt_reward_slow', 'RIBBON_MAIN_CALIBER', 'RIBBON_TORPEDO', 
    'RIBBON_BOMB', 'RIBBON_PLANE', 'RIBBON_CRIT', 'RIBBON_FRAG', 'RIBBON_BURN', 'RIBBON_FLOOD', 
    'RIBBON_CITADEL', 'RIBBON_BASE_DEFENSE', 'RIBBON_BASE_CAPTURE', 'RIBBON_BASE_CAPTURE_ASSIST', 
    'RIBBON_SUPPRESSED', 'RIBBON_SECONDARY_CALIBER', 'RIBBON_MAIN_CALIBER_OVER_PENETRATION', 
