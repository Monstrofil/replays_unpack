...
class Account(Entity):
    ...
    g_receivePreBattleData = EventHook()
    
    g_receivePreBattleCreatorDef = EventHook()
    
    g_receivePreBattlePlayerData = EventHook()
    
    g_receiveDescription = EventHook()
    
    g_receiveBattleDef = EventHook()
    ...
    g_curVersion_Release_0_6_9_0_273271 = EventHook()
    ...
    g_onGetClubBattlesStage = EventHook()
    ...
    g_cmdS1I1C1 = EventHook()
    
    g_cmdI1M1 = EventHook()
    
    g_cmdI1Ab1 = EventHook()
    ...
    @unpack_func_args(['PRE_BATTLE_ID', 'UINT8', 'BLOB'])
    def receivePreBattleData(self, arg1, arg2, arg3):
        self.g_receivePreBattleData.fire(self, arg1, arg2, arg3)

    @unpack_func_args(['PRE_BATTLE_ID', 'PRE_BATTLE_CREATOR_DEF'])
    def receivePreBattleCreatorDef(self, arg1, arg2):
        self.g_receivePreBattleCreatorDef.fire(self, arg1, arg2)

    @unpack_func_args(['PRE_BATTLE_ID', 'BLOB', 'BOOL'])
    def receivePreBattlePlayerData(self, arg1, arg2, arg3):
        self.g_receivePreBattlePlayerData.fire(self, arg1, arg2, arg3)

    @unpack_func_args(['UNICODE_STRING'])
    def receiveDescription(self, arg1):
        self.g_receiveDescription.fire(self, arg1)

    @unpack_func_args(['BATTLE_DEF'])
    def receiveBattleDef(self, arg1):
        self.g_receiveBattleDef.fire(self, arg1)
    ...
    @unpack_func_args([])
    def curVersion_Release_0_6_9_0_273271(self):
        self.g_curVersion_Release_0_6_9_0_273271.fire(self)
    ...
    @unpack_func_args(['UINT32', 'UINT8'])
    def onGetClubBattlesStage(self, arg1, arg2):
        self.g_onGetClubBattlesStage.fire(self, arg1, arg2)
    ...
    def onChangeLootbox(self, arg1, arg2):
        self.g_onChangeLootbox.fire(self, arg1, arg2)
    ...
    @unpack_func_args(['UINT32', 'UINT8', 'UINT16', ['ARRAY', 'UINT32']])
    ...
    @unpack_func_args(['STRING', 'UINT16', 'STRING'])
    def getAccountData(self, arg1, arg2, arg3):
        self.g_getAccountData.fire(self, arg1, arg2, arg3)
    ...
    @unpack_func_args(['UINT8', 'UINT8', 'UINT32', 'UINT32', 'UINT32', 'UINT32', 'UINT32', 'UINT32', 'UINT32', 'UNICODE_STRING'])
    ...
    @unpack_func_args(['UINT8', 'UINT8', 'UNICODE_STRING', 'INT32', 'ITEM_COST'])
    def cmdS1I1C1(self, arg1, arg2, arg3, arg4, arg5):
        self.g_cmdS1I1C1.fire(self, arg1, arg2, arg3, arg4, arg5)

    @unpack_func_args(['UINT8', 'UINT8', 'INT32', 'MODOP_INFO'])
    def cmdI1M1(self, arg1, arg2, arg3, arg4):
        self.g_cmdI1M1.fire(self, arg1, arg2, arg3, arg4)

    @unpack_func_args(['UINT8', 'UINT8', 'INT32', 'ABILOP_INFO'])
    def cmdI1Ab1(self, arg1, arg2, arg3, arg4):
        self.g_cmdI1Ab1.fire(self, arg1, arg2, arg3, arg4)
